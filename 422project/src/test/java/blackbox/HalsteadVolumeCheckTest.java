...
public class HalsteadVolumeCheckTest {
    ...
    void test() throws IOException, CheckstyleException {
        ...
        System.out.println("\nHalstead Length: " + check.count);

        int vocabulary = check.uniqueOperators.size() + check.uniqueOperands.size();
        System.out.println("Halstead Vocabulary: " + vocabulary);
        ...
        assertTrue(results.get("Halstead Volume:") == volume);
        System.out.println("Halstead Volume Test Complete\n");
    }
