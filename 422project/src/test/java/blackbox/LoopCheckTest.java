...
public class LoopCheckTest {
	...
	void test() throws IOException, CheckstyleException {
		...
		File file = new File(filePath + "LoopTestInput.java");
		...
		// verify results
		assertTrue(results.get("Loops:") == 3);
		System.out.println("Loop Check Test Complete\n");		
	}
	
	// helper method for visiting tokens
