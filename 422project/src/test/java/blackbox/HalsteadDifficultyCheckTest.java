...
public class HalsteadDifficultyCheckTest {
    ...
    void test() throws IOException, CheckstyleException {
        ...
        System.out.println("\nOperands: "+check.operandCount);
        System.out.println("Unique Operands: "+check.uniqueOperands.size());
		System.out.println("Unique Operators: "+check.uniqueOperators.size());
        ...
        assertTrue(results.get("Halstead Difficulty:") == difficulty);
        System.out.println("Halstead Difficulty Test Complete\n");
    }
