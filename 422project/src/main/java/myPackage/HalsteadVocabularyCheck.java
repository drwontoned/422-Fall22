...
public class HalsteadVocabularyCheck extends AbstractCheck {
    ...
    public void visitToken(DetailAST aAST) {
        ...
        if ((tokenType == TokenTypes.IDENT)) {
            ...
            } else if (!uniqueOperands.contains(current)) {
            ...
            } else if (!uniqueOperators.contains(current)) {
                uniqueOperators.add(current);
            }
    ...
    public void finishTree(DetailAST rootAST) {
        //report the Halstead vocabulary
        int vocabulary = uniqueOperands.size() + uniqueOperators.size();
        log(rootAST.getLineNo(), "Halstead Vocabulary: " + vocabulary + " -KS");
    }
}